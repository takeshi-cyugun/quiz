...
クイズの出題形式（例: 選択式、入力式など）を選択する画面です。ユーザーは自分の学習スタイルや目的に合わせて、最適な形式を選ぶことができます。

![クイズ形式選択画面](frontend/static/image/select.png)
...
クイズの終了後、正解数や不正解数、正答率が表示されます。これにより、学習の成果をすぐに確認し、次の学習計画に役立てることができます。

![結果画面](frontend/static/image/result.png)
